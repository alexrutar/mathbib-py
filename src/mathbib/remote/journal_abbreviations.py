JOURNALS = {
    ...
    "Acta Mathematica Scientia. Series A. Shuxue Wuli Xuebao. Chinese Edition": "Acta Math. Sci. Ser. A (Chinese Ed.)",
    ...
    "Acta Mathematica Sinica. Chinese Series": "Acta Math. Sinica (Chinese Ser.)",
    ...
    "Acta Universitatis Palackianae Olomucensis Facultatis Medicae": "Acta Univ. Palack. Olomuc. Fac. Med.",
    ...
    "Advances in Applied Clifford Algebras": "Adv. Appl. Clifford Algebr.",
    ...
    "Advances in Difference Equations": "Adv. Difference Equ.",
    ...
    "Algebra and Logic": "Algebra Logic",
    "Algebra i Logika. Institut Diskretnoi Matematiki i Informatiki": "Algebra Logika",
    "Algebraic & Geometric Topology": "Algebr. Geom. Topol.",
    ...
    '"Analele Stiintifice ale Universitatii ``Al. I. Cuza\'\' din Iasi. Serie Noua. Matematica. Annals of the ``Alexandru Ioan Cuza University. New Series. Mathematics"""': "An. Stiint. Univ. Al. I. Cuza Iasi. Mat. (N.S.)",
    ...
    "Analysis and Applications": "Anal. Appl. (Singap.)",
    ...
    "Annals of Mathematics. Second Series": "Ann. of Math.",
    ...
    "Annals of Physics": "Ann. Physics",
    "Annals of Pure and Applied Logic": "Ann. Pure Appl. Logic",
    "Annals of Science": "Ann. of Sci.",
    ...
    "Annual Review of Nuclear and Particle Science": "Ann. Rev. Nuclear Particle Sci.",
    ...
    "Applicable Algebra in Engineering, Communication and Computing": "Appl. Algebra Engrg. Comm. Comput.",
    ...
    "Arabian Journal of Mathematics": "Arab. J. Math. (Springer)",
    ...
    "Berichte zur Wissenschaftsgeschichte": "Ber. Wiss.gesch.",
    ...
    "Biological Cybernetics": "Biol. Cybernet.",
    ...
    "Boletim da Sociedade Paranaense de Matematica. 3rd Serie": "Bol. Soc. Parana. Mat.",
    ...
    "Boletin de la Sociedad Matematica Mexicana. Third Series": "Bol. Soc. Mat. Mex.",
    ...
    "Bulletin de la Societe Mathematique de France": "Bull. Soc. Math. France",
    ...
    "Chinese Annals of Mathematics. Series B": "Chinese Ann. Math. Ser. B",
    ...
    "Combinatorics, Probability and Computing": "Combin. Probab. Comput.",
    ...
    "Complex Analysis and its Synergies": "Complex Anal. Synerg.",
    ...
    "Computational Statistics": "Comput. Statist.",
    "Computational Statistics & Data Analysis": "Comput. Statist. Data Anal.",
    ...
    "Differential Equations": "Differ. Equ.",
    ...
    "Discrete and Continuous Dynamical Systems. Series A": "Discrete Contin. Dyn. Syst.",
    ...
    "Dynamics of Partial Differential Equations": "Dyn. Partial Differ. Equ.",
    ...
    "ESAIM: Proceedings and Surveys": "ESAIM Proc. Surveys",
    ...
    "Electronic Journal of Boundary Elements": "Electron. J. Bound. Elem.",
    ...
    "Ergebnisse der Mathematik und ihrer Grenzgebiete. 3. Folge. A Series of Modern Surveys in Mathematics": "Ergeb. Math. Grenzgeb.",
    ...
    "European Journal of Applied Mathematics": "European J. Appl. Math.",
    ...
    "Evolution Equations and Control Theory": "Evol. Equ. Control Theory",
    ...
    "Games and Economic Behavior": "Games Econom. Behav.",
    ...
    "General Relativity and Gravitation": "Gen. Relativity Gravitation",
    ...
    "Glasgow Mathematical Journal": "Glasg. Math. J.",
    ...
    '"Godishnik na Sofiiskiya Universitet ``Sv. Kliment Okhridski\'\'. Fakultet po Matematika i Informatika. Annual of Sofia University ``St. Kliment Ohridski. Faculty of Mathematics and Informatics"""': '"God. Sofii. Univ. ``Sv. Kliment Okhridski. Fac. Mat. Inform."""',
    ...
    "Heat and Mass Transfer": "Heat Mass Transf.",
    ...
    "IEEE Transactions on Signal and Information Processing over Networks": "IEEE Trans. Signal Inform. Process. Netw.",
    ...
    "IMA Journal of Mathematical Control and Information": "IMA J. Math. Control Inform.",
    ...
    "Intelligent Robotics Autonomous Agents": "Intel. Robotics Auton. Agents",
    ...
    "International Mathematics Research Notices. IMRN": "Int. Math. Res. Not.",
    ...
    "Journal of Applied Logic": "J. Appl. Log.",
    ...
    "Journal of Applied Non-Classical Logics": "J. Appl. Non-Class. Log.",
    ...
    "Journal of Biological Systems": "J. Biol. Systems",
    ...
    "Journal of Computational Multiphase Flows": "J. Comput. Multiph. Flows",
    ...
    "Journal of Econometric Methods": "J. Econom. Methods",
    "Journal of Econometrics": "J. Econometrics",
    "Journal of Economic Dynamics & Control": "J. Econom. Dynam. Control",
    "Journal of Economic Theory": "J. Econom. Theory",
    ...
    "Journal of Engineering Mathematics": "J. Engrg. Math.",
    ...
    "Journal of Functional Programming": "J. Funct. Programming",
    ...
    "Journal of Logical and Algebraic Methods in Programming": "J. Log. Algebr. Methods Program.",
    ...
    "Journal of Mathematical Economics": "J. Math. Econom.",
    ...
    "Journal of Mathematical Psychology": "J. Math. Psych.",
    ...
    "Journal of Multiscale Modelling": "J. Multiscale Model.",
    ...
    "Journal of Spectral Theory": "J. Spectr. Theory",
    ...
    "Journal of Statistical Planning and Inference": "J. Statist. Plann. Inference",
    ...
    "Journal of Theoretical Biology": "J. Theoret. Biol.",
    ...
    "Journal of Time Series Analysis": "J. Time Series Anal.",
    ...
    "Journal of the Atmospheric Sciences": "J. Atmospheric Sci.",
    ...
    "Journal of the European Mathematical Society (JEMS)": "J. Eur. Math. Soc.",
    ...
    "Journal of the Iranian Statistical Society. (JIRSS)": "J. Iran. Stat. Soc.",
    ...
    "Kinetic and Related Models": "Kinet. Relat. Models",
    ...
    "Lecture Notes in Mathematics": "Lecture Notes in Math.",
    ...
    "Lecture Notes in Physics": "Lecture Notes in Phys.",
    ...
    "Mathematical Sciences": "Math. Sci. (Springer)",
    ...
    "Mathematics and Computers in Simulation": "Math. Comput. Simulation",
    ...
    "Mathematics for Applications": "Math. Appl. (Brno)",
    ...
    "Mathematics of Climate and Weather Forecasting": "Math. Clim. Weather Forecast.",
    ...
    "Michigan Mathematical Journal": "Michigan Math. J.",
    ...
    "Moscow Journal of Combinatorics and Number Theory": "Mosc. J. Comb. Number Theory",
    ...
    "National Academy Science Letters": "Nat. Acad. Sci. Lett.",
    ...
    "Naval Research Logistics": "Naval Res. Logist.",
    ...
    "Nonlinear Dynamics, Psychology, and Life Sciences": "Nonlinear Dyn. Psychol. Life Sci.",
    ...
    "North American Actuarial Journal": "N. Am. Actuar. J.",
    ...
    "Notre Dame Journal of Formal Logic": "Notre Dame J. Form. Log.",
    ...
    "Organizatsiya Vychislitelnykh Struktur i Protsessov": "Organiz. Vycisl. Struktur. Process.",
    ...
    "Partial Differential Equations and Applications": "Partial Differ. Equ. Appl.",
    ...
    "Philosophia Mathematica. Series III": "Philos. Math.",
    ...
    "Physica D. Nonlinear Phenomena": "Phys. D",
    ...
    "Probability in the Engineering and Informational Sciences": "Probab. Engrg. Inform. Sci.",
    ...
    "Proceedings of the Edinburgh Mathematical Society. Series II": "Proc. Edinb. Math. Soc.",
    ...
    "Proceedings of the London Mathematical Society. Third Series": "Proc. Lond. Math. Soc.",
    ...
    "REVSTAT Statistical Journal": "REVSTAT",
    ...
    "Rendiconti del Circolo Matematico di Palermo. Second Series": "Rend. Circ. Mat. Palermo",
    ...
    "Reviews of Modern Physics": "Rev. Modern Phys.",
    ...
    "Revista Internacional de Metodos Numericos para Calculo y Diseno en Ingenieria": "Rev. Int. Metod. Numer. Calc. Diseno Ing.",
    ...
    "Revista Mexicana de Fisica": "Rev. Mexicana Fis.",
    ...
    "Revista de la Real Academia de Ciencias Exactas, Fisicas y Naturales. Serie A. Matematicas. RACSAM": "Rev. R. Acad. Cienc. Exactas Fis. Nat. Ser. A Math. RACSAM",
    "Revista de la Real Academia de Ciencias Exactas, Fisicas, Quimicas y Naturales de Zaragoza. Serie 2": "Rev. R. Acad. Cienc. Exactas Fis. Quim. Nat. Zaragoza",
    "Revista de la Union Matematica Argentina": "Rev. Un. Mat. Argentina",
    ...
    "Routledge Philosophers": "Routledge Philos.",
    ...
    "Russian Mathematical Surveys": "Russian Math. Surveys",
    ...
    "SIAM Journal on Financial Mathematics": "SIAM J. Financial Math.",
    ...
    "SIAM/ASA Journal on Uncertainty Quantification": "SIAM/ASA J. Uncertain. Quantif.",
    ...
    "Sampling Theory, Signal Processing, and Data Analysis": "Sampl. Theory Signal Process. Data Anal.",
    ...
    "Sao Paulo Journal of Mathematical Sciences": "Sao Paulo J. Math. Sci.",
    ...
    "Sciences et Techniques en Perspective. IIe Serie": "Sci. Tech. Perspect.",
    ...
    "Statistical Communications in Infectious Diseases": "Stat. Commun. Infec. Dis.",
    ...
    "Statistics and Computing": "Statist. Comput.",
    ...
    "Stochastic Systems": "Stoch. Syst.",
    "Stochastics and Dynamics": "Stoch. Dyn.",
    ...
    "Systems & Control Letters": "Systems Control Lett.",
    ...
    "The American Statistician": "Amer. Statist.",
    ...
    "The British Journal for the Philosophy of Science": "British J. Philos. Sci.",
    ...
    "The Tohoku Mathematical Journal. Second Series": "Tohoku Math. J.",
    ...
    "The World of Learning": "World Learn.",
    ...
    "Theoretical and Mathematical Physics": "Theoret. and Math. Phys.",
    "Theoria. A Swedish Journal of Philosophy": "Theoria",
    "Theoria. Revista de Teoria, Historia y Fundamentos de la Ciencia. Segunda Epoca. An International Journal for Theory, History and Foundations of Science. Second Series": "Theoria (San Sebastian)",
    ...
    "Topics in Applied Physics": "Topics Appl. Phys.",
    ...
    "Trudy Seminara S. L. Soboleva, No. 2": "Trudy Sem. S. L. Soboleva, No. 2",
